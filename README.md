...
| ---------       | ------------------ | ---------------- | ------------------------------------        |
| Argo CD | v9.5.15            | `argocd`         | [View README](roles/argocd/README.md)       |
...
| Kargo         | v1.10.4            | `kargo`          | [View README](roles/kargo/README.md)       |
...
- **Role tag** — named after the role itself (e.g. `argocd`, `atlantis`, `clamav`, `gatus`, `gitlab_runner`, `headlamp`, `kargo`, `mailcrab`, `warpgate`, `zammad`). Use it to scope a run to a single application.
