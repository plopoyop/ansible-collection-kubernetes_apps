...
| ---------       | ------------------ | ---------------- | ------------------------------------        |
| Argo CD | v9.5.21            | `argocd`         | [View README](roles/argocd/README.md)       |
| Atlantis | v6.6.0            | `atlantis`       | [View README](roles/atlantis/README.md)       |
| ClamAV         | v3.7.1            | `clamav`         | [View README](roles/clamav/README.md)       |
| Gatus         | v1.5.0            | `gatus`          | [View README](roles/gatus/README.md)       |
| GitLab Runner         | v0.90.0            | `gitlab_runner`  | [View README](roles/gitlab_runner/README.md)       |
...
| Zammad         | v16.4.1            | `zammad`         | [View README](roles/zammad/README.md)       |
