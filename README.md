...
| ---------       | ------------------ | ---------------- | ------------------------------------        |
| Argo CD | v10.9.1            | `argocd`         | [View README](roles/argocd/README.md)       |
| Atlantis | v6.15.0            | `atlantis`       | [View README](roles/atlantis/README.md)       |
| ClamAV         | v3.7.3            | `clamav`         | [View README](roles/clamav/README.md)       |
| Gatus         | v1.5.0            | `gatus`          | [View README](roles/gatus/README.md)       |
| GitLab Runner         | v0.92.2            | `gitlab_runner`  | [View README](roles/gitlab_runner/README.md)       |
...
| Zammad         | v18.1.0            | `zammad`         | [View README](roles/zammad/README.md)       |
